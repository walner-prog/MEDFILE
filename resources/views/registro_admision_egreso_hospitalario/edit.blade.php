            ...
            <div class="col">
                <nav aria-label="breadcrumb" class="rounded-3 p-3 mb-4">
                    <ol id="breadcrumb" class="breadcrumb mb-0  text-light">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Admisión/Egreso Hospitalario</li>
            ...
            <div class="modal-dialog modal-xl" role="document">
             <div class="modal-content">
                 <div class="modal-header bg-primary">
                     <div class="row">
                         <div class="col-lg-8">
                             <h5 class="modal-title text-white" id="editAdmisionEgresoFormLabel{{ $admision->id }}"></h5>
