...
<body>
    <section>
        ...
        <div class="container mt-2">
          ...
          <div class="row">
              <div class="col-lg-2">
                  @can('crear-departamento', App\Models\Departamento::class)
                  <button class="btn btn-indigo mb-3" data-toggle="modal" data-target="#createDepartmentModal">
          ...
          <div class="table-responsive">
              <table id="departmentsTable" class="min-w-full w-100 border border-gray-300 shadow-md rounded-lg p-2">
                  ...
                  <div class="modal-content">
                      ...
                      <form action="{{ route('departamentos.store') }}" method="POST">
                          ...
                          <div class="modal-footer">
                              ...
                              <button type="submit" class="btn btn-info">Crear Departamento</button>
                          </div>
                      </form>
                  </div>
              </div>
      ...
      $(document).ready(function() {
          $('#departmentsTable').DataTable({
              processing: true,
              serverSide: true,
              ajax: "{{ url('api/departamentos') }}", // Cambiar a la ruta de tu API para departamentos
              columns: [
                  { data: 'id' },
                  { data: 'nombre',
                  ...
                  { data: 'descripcion',
                      render: function (data, type, row) {
                          return `<span class="font-weight-bold text-muted">${data}</span>`;
                      },
                  },
