...
<body class="index-page">
  ...
  <header id="header" class="header sticky-top">
    ...
    <div class="branding d-flex align-items-center">
      ...
      <div class="container position-relative d-flex align-items-center justify-content-between">
            ...
            <a href="{{ url('/welcome') }}" class="logo d-flex align-items-center me-auto">

          <!-- Uncomment the line below if you also wish to use an image logo -->
          <!-- <img src="assets/img/logo.png" alt=""> -->
          <h1 class="sitename"><img 
            src="{{ asset('storage/logo-icon.png') }}" 
            alt="logo" 
            class="img-fluid mb-4" 
            style="max-width: 400px; height: auto;"></h1>
        </a>

        <nav id="navmenu" class="navmenu">
          <ul>
            <li><a href="#hero" class="active">Hogar<br></a></li>
        ...
        <a class="cta-btn d-none d-sm-block" href="{{ url('login') }}">Make an Appointment</a>
        ...
        <div class="col-lg-12 mt-5">
          ...
          <div class="card">
              <div class=" card-header from-green-500 to-green-600 text-white text-center  p-2">
                  <h3 class="text-lg font-semibold card-title text-dark ">Calendario de Atención de Doctores</h3>
              </div>
              <div class="card-body">
                  <div class="col-lg-4">
  ...
  <script>
    $('#consultorio_select').on('change', function () {
         ...
         var url = "{{ route('horarios-consultorio', ':id') }}";
